...
hi NonText term=bold ctermfg=DarkGrey gui=bold guifg=LightBlue guibg=grey30
...
hi Comment term=bold ctermfg=DarkGrey gui=bold guifg=Blue guibg=DarkCyan

" Set the pop menu color
